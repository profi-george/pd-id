...
// Ближайший рабочий день — сама дата, если это не суббота, иначе воскресенье.
// Используется только там, где день подставляется автоматически (не было явного
// выбора пользователя) — суббота не должна получать задачи молча, только если
// день назвали прямо. Воскресенье само по себе рабочее и никуда не сдвигается.
